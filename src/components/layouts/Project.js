...
const Project = ({id, name, url, skills, git, demo, des, skillsBar}) => {
    console.log(des)
    return (
        <div data-aos="fade-up" className=" col-12 col-lg-4 project-card">
            ...
            { skills && <h3>{skills.map(skill => skill)}</h3> && <button type="button"  className="git-button"><a className="text-decoration-none git-link" target="_blank" href={git}>Github</a> </button> 
            }
